...
else if (date%100) return true;
else if (date%400) return false;
else return true;
}
...
function angleBetweenClockHands(date) {
  var min = new Date(date).getUTCMinutes(), hour = new Date(date).getUTCHours()%12;
  var angle = Math.abs((hour * 60 + min)*0.5 - (min * 6));
