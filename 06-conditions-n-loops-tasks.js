...
function doRectanglesOverlap(rect1, rect2) {
    var y12 = rect1.top + rect1.height;
    var x12 = rect1.left + rect1.width;
    var x22 = rect2.left + rect2.width;
    var y22 = rect2.top + rect2.height;
...
function timespanToHumanString(startDate, endDate) {
    ...
    if(dif<=(45*60*1000)) {
      return `${Math.round((dif-1)/(60*1000))} minutes ago`;
    }
    if (dif<=(90*60*1000)) {
      return 'an hour ago';
    }
    if (dif<=(22*3600*1000)) {
      return `${Math.round((dif-1)/(3600*1000))} hours ago`;
    }
    if (dif<=(36*3600*1000)) {
      return 'a day ago';
    }
    if(dif<=(25*24*3600*1000))
      return `${Math.round((dif-1)/(24*3600*1000))} days ago`;
...
function evaluateTicTacToePosition(position) {
    for(var i=0;i<3;i++)
    {
      if(position[0+i][0] && position[0+i][0]===position[0+i][1] && position[0+i][1]===position[0+i][2])
      return position[0+i][1];
    }
    for(i=0;i<3;i++)
    {
    if(position[0][0+i] && position[0][0+i]===position[1][0+i] && position[1][0+i]===position[2][0+i])
