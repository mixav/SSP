...
function getRectangleString(width, height) {
    var temp = '│'+ ' '.repeat(width-2) + '│\n';
    var str ='┌'+ '─'.repeat(width-2) + '┐\n' + temp.repeat(height-2)+'└'+ '─'.repeat(width-2) + '┘\n';
    return str;
}
...
function getCardId(value) {
  var s2 = 0, s = 0, s1 = 0;
  if (value[value.length-1] == '♣') s2 = 0;
    else if (value[value.length-1] == '♦') s2 = 13;
    else if (value[value.length-1] == '♥') s2 = 26;
    else if (value[value.length-1] == '♠') s2 = 39;
    if(parseInt(value[0])==1)
    s1 = 9;
    else if(parseInt(value[0]))
      s1 = parseInt(value[0])-1;
      else if (value[0] == 'A')
      s1 = 0;
      else if (value[0] == 'J')
      s1 = 10;
